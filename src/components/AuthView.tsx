...
import { Mail, Lock, Globe, Apple, ChevronRight, Loader2, Info } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center overflow-hidden bg-black font-sans">
      ...
      <div className="absolute top-0 left-0 right-0 p-8 flex justify-between items-center z-10">
        ...
        <div className="flex items-center space-x-8">
           ...
           <button className="px-6 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white text-xs font-bold uppercase tracking-widest hover:bg-white/10 transition-all">Sign Up</button>
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md p-6 animate-in zoom-in-95 duration-700">
        <div className="bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-[48px] p-12 shadow-[0_50px_100px_rgba(0,0,0,0.8)] overflow-hidden">
          ...
          <div className="relative text-center mb-10">
            <h2 className="text-4xl font-black text-white tracking-tighter mb-4">Welcome Back</h2>
            <p className="text-white/40 text-sm font-medium">Please enter your credentials to continue exploring Paris.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-4">
                ...
                <button type="button" className="text-[10px] font-black text-[var(--accent)] uppercase tracking-widest hover:underline">Forgot Password?</button>
              </div>
              <div className="relative group">
          ...
          <p className="mt-12 text-center text-xs font-medium text-white/40">
            Don't have an account? <button className="text-[var(--accent)] font-black hover:underline uppercase tracking-widest ml-1 text-[10px]">Sign up for free</button>
          </p>
        </div>
      </div>
